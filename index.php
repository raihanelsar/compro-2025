...
$queryAbout = mysqli_query($koneksi, "SELECT * FROM about WHERE is_active = 1 ORDER BY id DESC LIMIT 1");
      ...
      <div class="container">
        <?php if ($rowAbout): ?>
          ...
          <div class="col-md-6 text-center">
            <img src="admin/uploads/<?php echo $rowAbout['image']; ?>" alt="About Image" style="max-width: 800px">
            <p><?php echo nl2br($rowAbout['content']); ?></p>
          </div>
        <?php else: ?>
          <p class="text-center">Konten "Tentang Kami" belum tersedia.</p>
        <?php endif; ?>
      </div>
